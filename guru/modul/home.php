							...
							<div class="card full-height">
								<div class="card-body">
									<div class="card-title">
										<center>
											<img src="../assets/img/LOGO POLITEKNIK TEDC BANDUNG.png" width="50">
											<br>
									...
									<div class="tab-content mt-2 mb-3" id="pills-with-icon-tabContent">
										...
										<div class="tab-pane fade" id="pills-contact-icon" role="tabpanel" aria-labelledby="pills-contact-tab-icon">
											<p>
												...
												Aplikasi Absensi Mahasiswa ini dibuat untuk mendokumentasikan kehadiran mahasiswa atau pelajar, Aplikasi sangat Mudah digunakan (Berbasis Web)
											</p>
										</div>
									</div>
								</div>
